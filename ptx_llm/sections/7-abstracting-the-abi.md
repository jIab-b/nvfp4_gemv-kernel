...
7.1. [Function Declarations and Definitions](#function-declarations-and-definitions)[](#function-declarations-and-definitions "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### 7.1.1. [Changes from PTX ISA Version 1.x](#changes-from-ptx-isa-version-1-x)[](#changes-from-ptx-isa-version-1-x "Permalink to this headline")
...
7.2. [Variadic Functions](#variadic-functions)[](#variadic-functions "Permalink to this headline")
---------------------------------------------------------------------------------------------------
...
7.3. [Alloca](#alloca)[](#alloca "Permalink to this headline")
---------------------------------------------------------------
