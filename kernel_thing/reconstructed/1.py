    ...
    uint16_t (&sfb_regs)[2])
{
    ...
    asm volatile(
        ...
        : "=l"(a_regs[0]), "=l"(a_regs[1]), "=l"(a_regs[2]), "=l"(a_regs[3]), "=l"(b_regs[0]), "=l"(b_regs[1]), "=l"(b_regs[2]), "=l"(b_regs[3])
        : "l"(rowA_addr), "l"(vecB_addr)
    )
    ...
    const uint16_t (&sfb_regs)[2])
{
    ...
    asm volatile(
        ...
        : "=h"(out_half_bits)
        : "r"(a_regs_packed[0]), "r"(a_regs_packed[1]), "r"(a_regs_packed[2]), "r"(a_regs_packed[3]), "r"(a_regs_packed[4]), "r"(a_regs_packed[5]), "r"(a_regs_packed[6]), "r"(a_regs_packed[7]), "r"(b_regs_packed[0]), "r"(b_regs_packed[1]), "r"(b_regs_packed[2]), "r"(b_regs_packed[3]), "r"(b_regs_packed[4]), "r"(b_regs_packed[5]), "r"(b_regs_packed[6]), "r"(b_regs_packed[7]), "h"(sfa_regs[0]), "h"(sfa_regs[1]), "h"(sfb_regs[0]), "h"(sfb_regs[1])
        : "memory"
    )
    ...
    uint16_t       sfb_regs)
{
    ...
    asm volatile(
        ...
        : "=f"(out_f32)
        : "r"(a_regs_packed[0]), "r"(a_regs_packed[1]), "r"(b_regs_packed[0]), "r"(b_regs_packed[1]), "h"(sfa_regs), "h"(sfb_regs), "r"(a_regs_packed[2]), "r"(a_regs_packed[3]), "r"(b_regs_packed[2]), "r"(b_regs_packed[3])
        : "memory"
    )
