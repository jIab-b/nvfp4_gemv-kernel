...
10.1. [Special Registers: `%tid`](#special-registers-tid)[](#special-registers-tid "Permalink to this headline")
-----------------------------------------------------------------------------------------------------------------
...
10.2. [Special Registers: `%ntid`](#special-registers-ntid)[](#special-registers-ntid "Permalink to this headline")
--------------------------------------------------------------------------------------------------------------------
...
10.3. [Special Registers: `%laneid`](#special-registers-laneid)[](#special-registers-laneid "Permalink to this headline")
--------------------------------------------------------------------------------------------------------------------------
...
10.4. [Special Registers: `%warpid`](#special-registers-warpid)[](#special-registers-warpid "Permalink to this headline")
--------------------------------------------------------------------------------------------------------------------------
...
10.5. [Special Registers: `%nwarpid`](#special-registers-nwarpid)[](#special-registers-nwarpid "Permalink to this headline")
-----------------------------------------------------------------------------------------------------------------------------
...
10.6. [Special Registers: `%ctaid`](#special-registers-ctaid)[](#special-registers-ctaid "Permalink to this headline")
-----------------------------------------------------------------------------------------------------------------------
...
10.7. [Special Registers: `%nctaid`](#special-registers-nctaid)[](#special-registers-nctaid "Permalink to this headline")
--------------------------------------------------------------------------------------------------------------------------
...
10.8. [Special Registers: `%smid`](#special-registers-smid)[](#special-registers-smid "Permalink to this headline")
--------------------------------------------------------------------------------------------------------------------
...
10.9. [Special Registers: `%nsmid`](#special-registers-nsmid)[](#special-registers-nsmid "Permalink to this headline")
-----------------------------------------------------------------------------------------------------------------------
...
10.10. [Special Registers: `%gridid`](#special-registers-gridid)[](#special-registers-gridid "Permalink to this headline")
---------------------------------------------------------------------------------------------------------------------------
...
10.11. [Special Registers: `%is_explicit_cluster`](#special-registers-is-explicit-cluster)[](#special-registers-is-explicit-cluster "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
10.12. [Special Registers: `%clusterid`](#special-registers-clusterid)[](#special-registers-clusterid "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------
...
10.13. [Special Registers: `%nclusterid`](#special-registers-nclusterid)[](#special-registers-nclusterid "Permalink to this headline")
---------------------------------------------------------------------------------------------------------------------------------------
...
10.14. [Special Registers: `%cluster_ctaid`](#special-registers-cluster-ctaid)[](#special-registers-cluster-ctaid "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------------
...
10.15. [Special Registers: `%cluster_nctaid`](#special-registers-cluster-nctaid)[](#special-registers-cluster-nctaid "Permalink to this headline")
---------------------------------------------------------------------------------------------------------------------------------------------------
...
10.16. [Special Registers: `%cluster_ctarank`](#special-registers-cluster-ctarank)[](#special-registers-cluster-ctarank "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------------------
...
10.17. [Special Registers: `%cluster_nctarank`](#special-registers-cluster-nctarank)[](#special-registers-cluster-nctarank "Permalink to this headline")
---------------------------------------------------------------------------------------------------------------------------------------------------------
...
10.18. [Special Registers: `%lanemask_eq`](#special-registers-lanemask-eq)[](#special-registers-lanemask-eq "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------
...
10.19. [Special Registers: `%lanemask_le`](#special-registers-lanemask-le)[](#special-registers-lanemask-le "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------
...
10.20. [Special Registers: `%lanemask_lt`](#special-registers-lanemask-lt)[](#special-registers-lanemask-lt "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------
...
10.21. [Special Registers: `%lanemask_ge`](#special-registers-lanemask-ge)[](#special-registers-lanemask-ge "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------
...
10.22. [Special Registers: `%lanemask_gt`](#special-registers-lanemask-gt)[](#special-registers-lanemask-gt "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------
...
10.23. [Special Registers: `%clock`, `%clock_hi`](#special-registers-clock)[](#special-registers-clock "Permalink to this headline")
-------------------------------------------------------------------------------------------------------------------------------------
...
10.24. [Special Registers: `%clock64`](#special-registers-clock64)[](#special-registers-clock64 "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------
...
10.25. [Special Registers: `%pm0` … `%pm7`](#special-registers-pm0-pm7)[](#special-registers-pm0-pm7 "Permalink to this headline")
-----------------------------------------------------------------------------------------------------------------------------------
...
10.26. [Special Registers: `%pm0_64` … `%pm7_64`](#special-registers-pm0-64-pm7-64)[](#special-registers-pm0-64-pm7-64 "Permalink to this headline")
-----------------------------------------------------------------------------------------------------------------------------------------------------
...
10.27. [Special Registers: `%envreg<32>`](#special-registers-envreg-32)[](#special-registers-envreg-32 "Permalink to this headline")
-------------------------------------------------------------------------------------------------------------------------------------
...
10.28. [Special Registers: `%globaltimer`, `%globaltimer_lo`, `%globaltimer_hi`](#special-registers-globaltimer)[](#special-registers-globaltimer "Permalink to this headline")
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
`%reserved_smem_offset_cap`, `%reserved_smem_offset_<2>`](#special-registers-reserved-smem)[](#special-registers-reserved-smem "Permalink to this headline")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
10.30. [Special Registers: `%total_smem_size`](#special-registers-total-smem-size)[](#special-registers-total-smem-size "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------------------
...
10.31. [Special Registers: `%aggr_smem_size`](#special-registers-aggr-smem-size)[](#special-registers-aggr-smem-size "Permalink to this headline")
---------------------------------------------------------------------------------------------------------------------------------------------------
...
10.32. [Special Registers: `%dynamic_smem_size`](#special-registers-dynamic-smem-size)[](#special-registers-dynamic-smem-size "Permalink to this headline")
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
10.33. [Special Registers: `%current_graph_exec`](#special-registers-current-graph-exec)[](#special-registers-current-graph-exec "Permalink to this headline")
---------------------------------------------------------------------------------------------------------------------------------------------------------------
